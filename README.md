...
2. 노래 제목, 유튜브 링크, 노래 가사를 입력합니다. (일본어 노래 가사의 경우 일본어만 입력해 주세요. 독음/번역은 알아서 만들어집니다.)
3. "번역하기" 버튼을 클릭하여 AI 번역을 시작합니다. (최대 3분까지 소요될 수 있습니다. 페이지를 닫아도 정상적으로 처리되기 때문에, 오래 걸린다면 3분 뒤에 다시 사이트에 방문해 보세요.)
