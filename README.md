...
- **획순 보기**: 가사에서 한자(히라가나/가타카나)를 드래그하면, 획순 애니메이션을 좌측 하단 패널로 표시
...
### 한자 획순 보기(드래그)
가사 보기 페이지에서 텍스트를 드래그로 선택하면, 선택된 문자열의 **첫 한자/가나** 획순 애니메이션이 좌측 하단에 표시됩니다.

![한자 획순 보기 데모](example_img/drag-kanji.gif)
